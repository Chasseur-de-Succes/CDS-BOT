...
module.exports.run = async (interaction) => {
    const group = interaction.options._group; // 'list', 'admin'
...
const list = async (interaction, options, showGame = false) => {
    ...
    if (!userDB)
        return interaction.reply({ embeds: [createError(`Tu n'as pas de compte ! Merci de t'enregistrer avec la commande : \`${PREFIX}register\``)] });
