...
module.exports = {
    ...
    async execute(interaction) {
        const steamID64 = interaction.options.getString('id-steam-64') ?? "Aucune id64 renseignée.";
        ...
        const msg = await interaction.reply({ embeds: [embedVerif], components: [row], fetchReply: true });
        ...
        const confirm = msg.createMessageComponentCollector({ filter: confirmFilter, time: timer });
        const cancel = msg.createMessageComponentCollector({ filter: cancelFilter, time: timer });
