...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const steamAvatar = await Canvas.loadImage(user.displayAvatarURL({extension: 'png', size: 128}))
        ...
        const file = new AttachmentBuilder(await canvas.toBuffer(), { name : `profil-${pseudo}.png` } )
